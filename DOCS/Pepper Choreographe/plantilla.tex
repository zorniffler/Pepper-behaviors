...
\begin{figure}[ht]
	...
	\label{Awaken2}
\end{figure}
An image depicting the Sun will appear in the screen after the robot wakes up and says its wake up message. The image is the one shown in \ref{IlSole}.
\begin{figure}[ht]
	\centering
	\includegraphics[scale=0.5]{SunImage.png}
...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=0.5]{faceanddialog1.png}
	\caption{FaceAndDialog box diagram.}
	\label{FaceAndDialog1}
\end{figure}
It executes the next dialog:
\lstinputlisting{../src/Dialogue_Sun/Dialogue_Sun_enu.top}
...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=0.5]{plano2500.png}
